...
export const textSections: { [key: string]: EditBoxSection } = {
    ...
    scrolling: {
        ...
        inputs: [
            ...
            [{ id: "scrolling.continuousLoop", type: "checkbox", value: false, values: {label: "edit.continuous_loop"}}],
            [{ id: "scrolling.gap", type: "number", value: 100, values: {label: "edit.gap", min: 0, max: 500}}]
        ]
    },
    special: {
